...
class AIAssistant {
    constructor() {
        this.trigger = document.getElementById('aiTrigger');
        this.interface = document.getElementById('aiInterface');
        this.chatBody = document.getElementById('aiChatBody');
        this.input = document.getElementById('aiTextInput');
    ...
    bindEvents() {
        ...
        this.trigger.addEventListener('click', () => this.toggleInterface());
    ...
    sendMessage(text) {
        ...
        // شبیه‌سازی پاسخ (بعداً به Sim.ai وصل می‌شود)
        setTimeout(() => {
            this.addMessage("در حال پردازش درخواست شما...", 'bot');
            
            // اینجا بعداً API Call به Sim.ai انجام می‌شود
            // fetch('SIM_AI_ENDPOINT', { ... })
    ...
    toggleVoice() {
        ...
        recognition.onresult = (event) => {
            ...
            this.sendMessage(transcript); // ارسال خودکار بعد از تشخیص گفتار
